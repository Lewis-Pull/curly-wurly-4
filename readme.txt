...
> <strong>Permissions Pro</strong><br />
> This plugin is the free version of the Permissions Pro plugin that comes with all the features you need to control access for your WordPress users. <a href="https://publishpress.com/permissions"  title="Permissions Pro">Click here to purchase the advanced WordPress permissions plugin now!</a>
...
1. Custom viewing permissions: PublishPress Permissions allows you to customize viewing access for all your content.
2. Custom editing permissions: PublishPress Permissions allows you to customize the editing permissions for all your content. 
3. Content creation permissions: PublishPress Permissions allows you to customize the create permissions for all your content. 
4. Create custom groups: PublishPress Permissions allows you to customize the create permissions for all your content. 
5. Manage media library access: PublishPress Permissions gives you detailed control over access to media on your WordPress site.
6. Show content teasers: PublishPress Permissions Pro allows you to display a teaser for unreadable content.
7. Synchronize content to users: This Pro feature allows you to automatically create content for your users. For example, you can sync your staff members to Pages. 
8. Create your own Workflow Statuses: WordPress provides some status options including “Draft” and “Published”. Permissions Pro enables you to design a far more advanced workflow. 
9. Create your own Privacy Statuses: With PublishPress Permissions Pro, you can create visibility options for your content. One example is a “Premium” status that makes content visible only for paying members. 
